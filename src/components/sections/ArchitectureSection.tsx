...
export function ArchitectureSection() {
  const { formData, files, updateFormData, updateFiles, setCurrentSection } = useDesignBrief();
          ...
          <TabsContent value="architecture" className="mt-0">
            <div className="design-brief-form-group">
              ...
              <div className="mb-6">
                ...
                <p className="design-brief-question-description">
                  What sustainability features or goals do you have for your project?
                </p>
                <Textarea
